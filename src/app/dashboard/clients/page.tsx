        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <Link href="/dashboard/clients/new">
              <button className={`px-4 py-2 rounded-lg border text-sm transition-all focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 flex items-center gap-2 ${
                isDark
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg border text-sm transition-all focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 flex items-center gap-2 ${
                    isDark
                      ? 'border-slate-700 bg-slate-800 text-slate-200 hover:bg-slate-700'
                      : 'border-gray-300 bg-white text-gray-900 hover:bg-gray-50'
                  }`}
            ...
            <div className={`rounded-lg border shadow-xl transition-colors duration-300 ${
              ...
              <div className="flex flex-col items-center py-12">
                <div className={`mb-4 flex h-24 w-24 items-center justify-center rounded-full transition-colors duration-300 ${
                  ...
                  <HiUsers className={`h-12 w-12 transition-colors duration-300 ${
